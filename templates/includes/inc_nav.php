...
<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <li class="nav-item dropdown user-menu">
        ...
        <img src="<?= $_SESSION['user_session']['user']['avatar'] != null ? $_SESSION['user_session']['user']['avatar'] : 'https://ui-avatars.com/api/?name='.$_SESSION['user_session']['user']['name'].'+'.$_SESSION['user_session']['user']['lastname'].'&background=random&format=svg' ?>" class="user-image img-circle elevation-2" alt="User Image">
        <span class="d-none d-md-inline"><?= $_SESSION['user_session']['user']['name'].' '.$_SESSION['user_session']['user']['lastname'];?></span>
        </a>
        ...
        <li class="user-header bg-primary">
            ...
            <p>
            <?= $_SESSION['user_session']['user']['name'].' '.$_SESSION['user_session']['user']['lastname'];?>
